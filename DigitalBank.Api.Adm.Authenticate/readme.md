...
>DigitalBank.Api.Adm.Authenticate - Api Administrativa de Autenticação


**Api Administrativa de Autenticação**
...
| /authenticate/v1 | v1 | Método para efetuar autenticação/login | POST |  --- |
